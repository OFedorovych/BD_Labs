...
public class Rating {
    ...
    private ua.lviv.iot.domain.Goods goodsByGoodId;
    ...
    public ua.lviv.iot.domain.Goods getGoodsByGoodId() {
        return goodsByGoodId;
    }

    public void setGoodsByGoodId(ua.lviv.iot.domain.Goods goodsByGoodId) {
