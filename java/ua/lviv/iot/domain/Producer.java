...
public class Producer {
    ...
    private Collection<ua.lviv.iot.domain.Goods> goodsById;
    private ua.lviv.iot.domain.Country countryByCountryId;
    ...
    public void setCountryByCountryId(ua.lviv.iot.domain.Country countryByCountryId) {
